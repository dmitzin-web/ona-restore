...
export default function HazelDellPage() {
  return (
    <LocationPage
      city="Hazel Dell"
      state="WA"
      intro="ONA Restore provides water damage restoration, fire and smoke damage support, mold remediation planning, reconstruction, and remodeling services for homeowners in Hazel Dell and the Vancouver WA area."
      nearbyAreas={[
