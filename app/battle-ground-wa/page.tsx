export const metadata = {
  title: 'Restoration Company in Battle Ground WA',
  description:
    'Water damage, fire damage, mold remediation, reconstruction, and remodeling services in Battle Ground WA and Clark County.',
}
